...
class GalleryFragment : Fragment(), OnMapReadyCallback {
    ...
    //mapa:Ojo que se toman los datos de lugarViewModel
        ...
        fusedLocation.lastLocation.addOnSuccessListener { location: Location? ->
            if (location != null) {
                val cameraUpdate = CameraUpdateFactory.newLatLngZoom(
                    LatLng(9.97, -84.00/*location.latitude,location.longitude*/), 15f)//se puede quitar las cordenadas fijas y descomentar la linea
